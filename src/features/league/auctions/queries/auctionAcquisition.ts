...
import { AuctionParticipantWithAcquisitions } from "./auctionParticipant";

export type ParticipantAcquisition = AuctionParticipantWithAcquisitions["acquisitions"][number]
