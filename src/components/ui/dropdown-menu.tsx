...
function DropdownMenuTrigger({
  ...
  return (
    <DropdownMenuPrimitive.Trigger
      ...
      className={cn("cursor-pointer focus:!ring-0 active:!border-0", className)}
      {...props}
    />
  )
}
